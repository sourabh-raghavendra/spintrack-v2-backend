...
export const getSixMonthWarrantyCertificateDefinition = (
  ...
  return {
    ...
    // 1. Authoritative Canvas Borders for both pages
    ...
    content: [
            ...
            [
              {
                ...
                alignment: "center",
                margin: [0, 10, 0, 10],
                fillColor: "#eaf2f8", // Light blue background banner
                border: [false, true, false, true], // Top and bottom borders only
              },
            ],
          ],
        },
      ...
      },
      {
        text: [
          ...
          ", are liable to offer free of cost\nrepair services if, spindle fails within six months because\nof our services quality *",
        ],
        fontSize: 14,
        alignment: "center",
        lineHeight: 1.4,
      ...
      // Dynamic Form Fields (Aligned layout)
      {
        columns: [
      ...
      // ================= PAGE 2 (Terms & Conditions) =================
      {
        ...
        bold: true,
        alignment: "center",
        pageBreak: "before", // Forces this content to page 2
        margin: [0, 10, 0, 10],
      },
      {
        table: {
            ...
            [
              {
                ...
                color: "white",
                fillColor: "#85c1e9", // Light blue box
                fontSize: 14,
                bold: true,
                alignment: "center",
                padding: [20, 5, 20, 5],
      ...
      },
      {
        columns: [
          ...
          { width: "10%", text: "" }, // Right Spacer
        ],
      },
      {
        text: "SETCO India/WC/020",
        fontSize: 9,
        color: "#777777",
        alignment: "left",
        margin: [0, 10, 0, 0],
...
const generateSixMonthWarrantyCertificate = (data: CertificateData): void => {
  const docDefinition = getSixMonthWarrantyCertificateDefinition(data);
  pdfMake
    .createPdf(docDefinition)
    .download(`6_Month_Warranty_Certificate_${data.certificateNo || "Draft"}.pdf`);
};

export default generateSixMonthWarrantyCertificate;
...
export const WarrantyCertificate: React.FC<WarrantyCertificateProps> = ({
  ...
  return (
    <div style={{ padding: "20px", fontFamily: "sans-serif" }}>
      ...
      <p>Sr. No: {data.srNo}</p>
      <button
        onClick={() => generateSixMonthWarrantyCertificate(data)}
        style={{
          padding: "10px 20px",
      ...
      >
        Download 6-Month PDF Certificate
      </button>
    </div>
  );
};
